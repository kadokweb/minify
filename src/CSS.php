 ...
 * CSS Minifier
 *
 * Please report bugs on https://github.com/kadokweb
 *
 * @author Doka Silva <doka@kadok.com.br>
 * @copyright Copyright (c) 2012, Doka Silva. All rights reserved
 * @license MIT License
 */

namespace KadokWeb\Minify;

use KadokWeb\Minify\Exceptions\FileImportException;
use KadokWeb\PathConverter\ConverterInterface;
...
class CSS extends Minify
{
    ...
    protected function move(ConverterInterface $converter, $content)
    {
        ...
        foreach ($matches as $match) {
             ...
             * @see https://github.com/kadokweb/193
             */
            $url = trim($url);
    ...
    protected function shortenZeroes($content)
    {
        ...
        // @see https://github.com/kadokweb/60
