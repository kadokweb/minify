...
class CSSTest extends TestCase
{
    protected function mockMinifier()
    {
        ...
        return $this->getMockBuilder('\kadokweb\Minify\CSS')
    ...
    {
        $this->expectException('KadokWeb\Minify\Exceptions\FileImportException');
...
body{
     background: white;
        ...
        // https://github.com/kadokweb/minify/commit/3253a81d07cd01afcb651e309900d8ad58a052da#commitcomment-19223603
        $tests[] = array(
            'p{border: 1px solid #f00000;}',
            'p{border:1px solid #f00000}',
        );

        // https://github.com/kadokweb/149
        $tests[] = array(
            ".headerWrapper{
...
@media (min-width: 1200px) {}',
        ...
        // https://github.com/kadokweb/216
        $tests[] = array(
            '.link-wrapper a:before{content:"Click for Download";}',
            '.link-wrapper a:before{content:"Click for Download"}',
        );

        // https://github.com/kadokweb/217
        $tests[] = array(
...
body{font-family:sans-serif}',
        ...
        // https://github.com/kadokweb/267
        $tests[] = array(
            'ul p { padding-left: calc((var(--icon-size) / 2) + var(--horisontal-space)); }',
            'ul p{padding-left:calc((var(--icon-size) / 2) + var(--horisontal-space))}',
        );

        // https://github.com/kadokweb/351
        $tests[] = array(
            'clamp(2.5rem, 1rem + 4vw, 4rem)',
            'clamp(2.5rem, 1rem + 4vw, 4rem)',
        );

        // https://github.com/kadokweb/342
        $tests[] = array(
...
margin-left: calc(20px + var(--some-var));
    ...
    public function dataProviderPaths()
    {
        ...
        // https://github.com/kadokweb/77#issuecomment-172844822
        $tests[] = array(
